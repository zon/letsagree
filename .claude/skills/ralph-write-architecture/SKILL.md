...
8. **Draft the architecture** following the format in [docs/formats/architecture.md](https://raw.githubusercontent.com/zon/ralph/refs/heads/main/docs/formats/architecture.md).
