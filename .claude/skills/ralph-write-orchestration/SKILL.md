...
6. **Draft the orchestration and tests** following the format and guidelines in [docs/formats/orchestration.md](https://raw.githubusercontent.com/zon/ralph/refs/heads/main/docs/formats/orchestration.md).
